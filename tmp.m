...
% minimal plotting
drtoolbox.techniques.dpca_plot(firingRatesAverage, W, W, @drtoolbox.techniques.dpca_plot_default);

% computing explained variance
explVar = drtoolbox.techniques.dpca_explainedVariance(firingRatesAverage, W, W, ...
...
drtoolbox.techniques.dpca_perMarginalization(firingRatesAverage, @drtoolbox.techniques.dpca_plot_default, ...
   'combinedParams', combinedParams);
...
tic
[W,V,whichMarg] = drtoolbox.techniques.dpca(firingRatesAverage, 20, ...
    'combinedParams', combinedParams);
toc

explVar = drtoolbox.techniques.dpca_explainedVariance(firingRatesAverage, W, V, ...
    'combinedParams', combinedParams);

drtoolbox.techniques.dpca_plot(firingRatesAverage, W, V, @drtoolbox.techniques.dpca_plot_default, ...
    'explainedVar', explVar, ...
    'marginalizationNames', margNames, ...
    'marginalizationColours', margColours, ...
    'whichMarg', whichMarg,                 ...
...
optimalLambda = drtoolbox.techniques.dpca_optimizeLambda(firingRatesAverage, firingRates, trialNum, ...
    'combinedParams', combinedParams, ...
    'simultaneous', ifSimultaneousRecording, ...
    'numRep', 2, ...  % increase this number to ~10 for better accuracy
    'filename', 'tmp_optimalLambdas.mat');

Cnoise = drtoolbox.techniques.dpca_getNoiseCovariance(firingRatesAverage, ...
...
accuracy = drtoolbox.techniques.dpca_classificationAccuracy(firingRatesAverage, firingRates, trialNum, ...
    'lambda', optimalLambda, ...
    'combinedParams', combinedParams, ...
...
drtoolbox.techniques.dpca_classificationPlot(accuracy, [], [], [], decodingClasses)

accuracyShuffle = drtoolbox.techniques.dpca_classificationShuffled(firingRates, trialNum, ...
    'lambda', optimalLambda, ...
    'combinedParams', combinedParams, ...
    'decodingClasses', decodingClasses, ...
    'simultaneous', ifSimultaneousRecording, ...
...
drtoolbox.techniques.dpca_classificationPlot(accuracy, [], accuracyShuffle, [], decodingClasses)

componentsSignif = drtoolbox.techniques.dpca_signifComponents(accuracy, accuracyShuffle, whichMarg);
